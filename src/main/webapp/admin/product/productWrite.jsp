	...
	<form name="frm" method="post" enctype="multipart/form-data" >
		<table id="list">
			<tr>
				...
				<td colspan="5">
					<select name="kind">
						...
						<!-- status.count 는 1부터 시작하므로 배열의 첫번째 데이터와 kind 가 일치되어 value 에 지정됩니다 -->
					</select>
				</td>
			</tr>
			
			<tr>
				<th>상품명</th><td width="343" colspan="5">
			...
			<tr>
				...
				<th>마진[B-A]</th><td width="72">	<input type="text" name="price3" size="11" ></td>
			</tr>
